...
foreach ($articles as $article) { ?>
                    ...
                    <div class="post-content">
                        <header class="entry-header text-center text-uppercase">
                            ...
                            <h1 class="entry-title"><a href="<?= yii\helpers\Url::toRoute(['site/category', 'id'=>$article->category->id]); ?>"><?= $article->title; ?></a></h1>
                        ...
                        <div class="entry-content">
                            ...
                            <div class="btn-continue-reading text-center text-uppercase">
                                <a href="<?= yii\helpers\Url::toRoute(['site/view', 'id'=>$article->id]); ?>" class="more-link">Continue Reading</a>
                            </div>
                        </div>
